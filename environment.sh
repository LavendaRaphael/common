...
gotolog_1=${homedir}group/202103_XasPtO/log/server/Pt-111_O_vac/Pt-111a4b4c4_O4_vac15/
echo "gotolog_1=$gotolog_1"

gotolog_2=${homedir}group/202103_XasPtO/log/server/Pt-110_O_vac/Pt-110a12b2c4.5_O22_vac15/qe_hch_scf/
echo "gotolog_2=$gotolog_2"
